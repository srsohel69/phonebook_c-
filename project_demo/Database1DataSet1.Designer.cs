...
namespace project_demo {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class registerDataTable : global::System.Data.TypedTableBase<registerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public registerRow AddregisterRow(string First_Name, string Last_Name, string Username, string Password) {
...
namespace project_demo.Database1DataSet1TableAdapters {
    ...
    public partial class registerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[register] WHERE (([First_Name] = @Original_First_Name) AND ((@IsNull_Last_Name = 1 AND [Last_Name] IS NULL) OR ([Last_Name] = @Original_Last_Name)) AND ([Username] = @Original_Username) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[register] ([First_Name], [Last_Name], [Username], [Password]) " +
                "VALUES (@First_Name, @Last_Name, @Username, @Password);\r\nSELECT First_Name, Last" +
                "_Name, Username, Password FROM register WHERE (Username = @Username)";
...
SELECT First_Name, Last_Name, Username, Password FROM register WHERE (Username = @Username)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT First_Name, Last_Name, Username, Password FROM dbo.register";
        ...
        public virtual int Delete(string Original_First_Name, string Original_Last_Name, string Original_Username, string Original_Password) {
        ...
        public virtual int Update(string First_Name, string Last_Name, string Username, string Password, string Original_First_Name, string Original_Last_Name, string Original_Username, string Original_Password) {
            if ((First_Name == null)) {
                throw new global::System.ArgumentNullException("First_Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string First_Name, string Last_Name, string Password, string Original_First_Name, string Original_Last_Name, string Original_Username, string Original_Password) {
            return this.Update(First_Name, Last_Name, Original_Username, Password, Original_First_Name, Original_Last_Name, Original_Username, Original_Password);
        }
    }
